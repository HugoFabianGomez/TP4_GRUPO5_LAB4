...
public class PantallaEjercicio_2 extends JFrame {
	...
	public PantallaEjercicio_2() {
		...
		textField_Nota1.addKeyListener(new KeyAdapter() { //Para que se cargue solo el valor correcto
			public void keyTyped(KeyEvent e) {
				char caracter =e.getKeyChar();
				if((caracter<'0'||caracter >'9')
					&&(caracter != KeyEvent.VK_BACK_SPACE)
					&& (caracter != '.' || textField_Nota1.getText().contains(".")))
				{
					e.consume();
				}
			}	
		...
		textField_Nota2.addKeyListener(new KeyAdapter() { //Para que se cargue solo el valor correcto
			public void keyTyped(KeyEvent e) {
				char caracter =e.getKeyChar();
				if((caracter<'0'||caracter >'9')
					&&(caracter != KeyEvent.VK_BACK_SPACE)
					&& (caracter != '.' || textField_Nota2.getText().contains(".")))
				{
					e.consume();
				}
			}	
		...
		textField_Nota3.addKeyListener(new KeyAdapter() { //Para que se cargue solo el valor correcto
			public void keyTyped(KeyEvent e) {
				char caracter =e.getKeyChar();
				if((caracter<'0'||caracter >'9')
					&&(caracter != KeyEvent.VK_BACK_SPACE)
					&& (caracter != '.' || textField_Nota3.getText().contains(".")))
				{
					e.consume();
				}
			}	
		...
		btnNuevo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				//AL LIMPIAR DEJA LOS VALORES NULOS
				...
				//AL LIMPIAR DEJA LAS CAJAS Y COMBOBOX CON FONDO BLANCO
				textField_Nota1.setBackground(Color.WHITE);
				textField_Nota2.setBackground(Color.WHITE);
				textField_Nota3.setBackground(Color.WHITE);
				comboBox_TPs.setBackground(Color.WHITE);
	...
	class eventobtnCalcular implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
			//Devuelve Fondo blanco cuando corrige los valores
			...
			if(comboBox_TPs.getSelectedItem().toString()== "Seleccione"){
				comboBox_TPs.setBackground(Color.RED); 
			}
